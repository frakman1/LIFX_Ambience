...
- (IBAction)done:(id)sender
{
    ...
    if ([self.delegate respondsToSelector:@selector(ImageCropViewController:didFinishCroppingImage: withDimension:)])
    {
        UIImage *cropped;
        CGRect CropRect;
        ...
        if (self.image != nil)
        {
            CropRect = self.cropView.cropAreaInImage; NSLog(@"CropRect: %@",NSStringFromCGRect(CropRect));
        ...
        [self.delegate ImageCropViewController:self didFinishCroppingImage:cropped withDimension:CropRect];
    }
