...
- (void)setFrame:(CGRect)frame {
    //CGRect myframe = CGRectMake(frame.origin.x,frame.origin.y,frame.size.width-60,frame.size.height);
    [super setFrame:frame];
    //NSLog(@"original:%@", NSStringFromCGRect(frame));
    //NSLog(@"mine:%@", NSStringFromCGRect(myframe));
...
- (void)setBounds:(CGRect)bounds {
    ...
    //CGRect mybounds = CGRectMake(bounds.origin.x,bounds.origin.y,bounds.size.width-60,bounds.size.height);
    [super setFrame:bounds];
    //NSLog(@"original:%@", NSStringFromCGRect(bounds));
    //NSLog(@"mine:%@", NSStringFromCGRect(mybounds));
